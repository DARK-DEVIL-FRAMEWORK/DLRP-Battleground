...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    disable = false
    TriggerServerEvent('ddfw-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('ddfw-weathersync:client:EnableSync', function()
    disable = false
    TriggerServerEvent('ddfw-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('ddfw-weathersync:client:DisableSync', function()
	disable = true
...
RegisterNetEvent('ddfw-weathersync:client:SyncWeather', function(NewWeather, newblackout)
    CurrentWeather = NewWeather
    blackout = newblackout
end)

RegisterNetEvent('ddfw-weathersync:client:SyncTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
