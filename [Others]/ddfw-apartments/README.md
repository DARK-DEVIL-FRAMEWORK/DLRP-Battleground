# ddfw-apartments
Apartments System for ddfw-Core Framework :office:
...
- [ddfw-clothing](https://github.com/qbcore-framework/ddfw-clothing) - To save outfits
- [ddfw-houses](https://github.com/qbcore-framework/ddfw-houses) - House logic
- [ddfw-interior](https://github.com/qbcore-framework/ddfw-interior) - Interior logic
- [ddfw-weathersync](https://github.com/qbcore-framework/ddfw-weathersync) - To desync weather while inside
- [ddfw-spawn](https://github.com/qbcore-framework/ddfw-spawn) - To spawn the player at apartment if last location was in apartment
...
- Import `ddfw-apartments.sql` in your database
- Add the following code to your server.cfg/resouces.cfg
```
ensure ddfw-core
ensure ddfw-interior
