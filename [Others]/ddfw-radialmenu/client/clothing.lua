...
RegisterNetEvent('ddfw-radialmenu:ResetClothing', ResetClothing)
...
RegisterNetEvent('ddfw-radialmenu:ToggleClothing', ToggleClothing)
...
RegisterNetEvent('ddfw-radialmenu:ToggleProps', ToggleProps)
