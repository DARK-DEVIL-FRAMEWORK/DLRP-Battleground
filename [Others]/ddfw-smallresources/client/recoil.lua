...
Citizen.CreateThread(function()
	while true do
		...
		--addon
		if weapon == GetHashKey("weapon_ak47") then		
			if IsPedShooting(ped) then
				ShakeGameplayCam('weapon_ak47', 0.085)
			end
		end

		if weapon == GetHashKey("weapon_m4") then		
			if IsPedShooting(ped) then
				ShakeGameplayCam('weapon_m4', 0.085)
			end
		end
