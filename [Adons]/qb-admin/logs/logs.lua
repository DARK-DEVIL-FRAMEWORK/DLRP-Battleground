...
RegisterNetEvent('qb-admin:log:minPage', function(webhook,event,color)
    local src = source
...
RegisterNetEvent('qb-admin:log:playersEvent', function(src,webhook,event,color,targetPlayer)
    local src = src
