...
RegisterNetEvent('qb-admin:client:SaveCar', function()
    ...
    if veh ~= nil and veh ~= 0 then
        ...
        if QBCore.Shared.Vehicles[vehname] ~= nil and next(QBCore.Shared.Vehicles[vehname]) ~= nil then
            ...
            TriggerServerEvent('qb-admin:log:minPage',"vehicle","savecar","blue")
        else
...
RegisterNetEvent('qb-admin:client:SetSpeed', function()
    local ped = PlayerId()
    speed = not speed
    TriggerServerEvent('qb-admin:log:minPage',"other","fast speed","blue")
    if speed then
...
RegisterNetEvent("qb-admin:client:reviveSelf", function()
    ...
    TriggerServerEvent('qb-admin:log:minPage',"revive","revive","black")
end)
...
RegisterNetEvent("qb-admin:client:godMode", function()
    godmode = not godmode
    TriggerServerEvent('qb-admin:log:minPage',"godmode","godmode","black")
    if godmode then
        while godmode do
            Wait(0)
...
RegisterNetEvent("qb-admin:client:infiniteAmmo", function()
    ...
    TriggerServerEvent('qb-admin:log:minPage',"other","infinite ammo","blue")
    local ped = PlayerPedId()
...
RegisterNetEvent("qb-admin:client:invisible", function()
    ...
    TriggerServerEvent('qb-admin:log:minPage',"invisible","invisible","black")
    if invisible then
...
RegisterNetEvent("qb-admin:client:vehicleGodMode", function()
    ...
    TriggerServerEvent('qb-admin:log:minPage',"vehicle","veh godmode","blue")
    local ped = PlayerPedId()
    local vehicle = GetVehiclePedIsIn(ped, false)
...
RegisterNetEvent('qb-admin:client:maxmodVehicle', function()
    ...
    TriggerServerEvent('qb-admin:log:minPage',"vehicle","maxmods","blue")
end)
