...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        ...
        emit("ddfw-admin:server:ban", player, time, reason);
        */
        ...
        emit("ddfw-log:server:CreateLog", "bans", "Player Banned", "red", `${GetPlayerName(args.id)} was banned by ${interaction.member.displayName} for ${args.reason}`, true);
