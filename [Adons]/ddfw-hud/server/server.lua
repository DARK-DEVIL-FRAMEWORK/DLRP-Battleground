...
Citizen.CreateThread(function()
    ...
    if Config.Framework == "esx" then
        frameworkObject.RegisterServerCallback("ddfw-hud:GetMoney", function(source, cb, moneytype)
            local src = source
...
RegisterServerEvent('ddfw-hud:RemoveItem')
AddEventHandler('ddfw-hud:RemoveItem', function(item, amount)
    local src = source
...
Citizen.CreateThread(function()
    ...
    for _,v in pairs(GetPlayers()) do
        ...
        if player ~= nil then
            ...
            TriggerClientEvent('ddfw-hud:client:UpdateSettings', v,  preferences[identifier])
            TriggerClientEvent('codem-blackhudv2:SetForceHide', v, false)
            TriggerClientEvent('ddfw-hud:UpdateNitroData', v, nitro)
            TriggerClientEvent('ddfw-hud:Loaded', v)
        end
    end
end)
...
RegisterNetEvent('ddfw-hud:UpdateData')
AddEventHandler("ddfw-hud:UpdateData", function(settingstype, val)
    local src = source
