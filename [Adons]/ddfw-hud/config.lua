...
Config.DefaultHudSize = 0.7 -- 0.5 - 1.3
...
Config.WaterMarkLogo = "https://cdn.discordapp.com/attachments/1072246335576744028/1101161525537931434/DL-PvP_-_C.png" -- Logo url
Config.LogoWidth = "100px"
...
Config.GetVehicleFuel = function(vehicle) -- you can change LegacyFuel export if you use another fuel system 
    if Config.UseLegacyFuel then
        return exports["ddfw-fuel"]:GetFuel(vehicle)
    else
