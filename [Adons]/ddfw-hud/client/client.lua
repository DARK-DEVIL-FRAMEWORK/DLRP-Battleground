...
RegisterNetEvent('ddfw-hud:Loaded')
AddEventHandler('ddfw-hud:Loaded', function()
    playerLoaded = true
end)
...
RegisterNetEvent('ddfw-hud:OnAddedMoney')
AddEventHandler("ddfw-hud:OnAddedMoney", function(amount, minus, moneyType)
...
RegisterNetEvent('ddfw-hud:client:UpdateSettings')
AddEventHandler('ddfw-hud:client:UpdateSettings', function(data)
...
function CinematicShow(bool)
    ...
    TriggerEvent('ddfw-hud:client:UpdateSettings', preferencesData)
    if bool then
