...
Config.JamChance = 100000000 -- 1/1000 chance of jamming per bullet fired
...
Config.DurabilityMultiplier = {
	...
	['weapon_poolcue'] 				 = 0.0,
	['weapon_briefcase'] 			 = 0.0,
	['weapon_briefcase_02'] 		 = 0.0,
	['weapon_garbagebag'] 			 = 0.0,
	['weapon_handcuffs'] 			 = 0.0,
	['weapon_bread'] 				 = 0.0,
	['weapon_stone_hatchet'] 		 = 0.0,

	-- Handguns
	['weapon_pistol'] 				 = 0.0,
	['weapon_pistol_mk2'] 			 = 0.0,
	...
	['weapon_vintagepistol'] 		 = 0.0,
	['weapon_flaregun'] 			 = 0.0,
	['weapon_marksmanpistol'] 		 = 0.0,
	['weapon_revolver'] 			 = 0.0,
	['weapon_revolver_mk2'] 		 = 0.0,
	['weapon_doubleaction'] 		 = 0.0,
	['weapon_snspistol_mk2'] 		 = 0.0,
	['weapon_raypistol'] 			 = 0.0,
	['weapon_ceramicpistol'] 		 = 0.0,
	['weapon_navyrevolver'] 		 = 0.0,
	['weapon_gadgetpistol'] 		 = 0.0,

	-- Submachine Guns
	['weapon_microsmg'] 			 = 0.0,
	['weapon_smg'] 				     = 0.0,
	['weapon_smg_mk2'] 				 = 0.0,
	['weapon_assaultsmg'] 			 = 0.0,
	['weapon_combatpdw'] 			 = 0.0,
	['weapon_machinepistol'] 		 = 0.0,
	['weapon_minismg'] 				 = 0.0,
	['weapon_raycarbine'] 			 = 0.0,

	-- Shotguns
	['weapon_pumpshotgun'] 			= 0.0,
	['weapon_sawnoffshotgun'] 		= 0.0,
	['weapon_assaultshotgun'] 		= 0.0,
	['weapon_bullpupshotgun'] 		= 0.0,
	['weapon_musket'] 				= 0.0,
	['weapon_heavyshotgun'] 		= 0.0,
	['weapon_dbshotgun'] 			= 0.0,
	['weapon_autoshotgun'] 			= 0.0,
	['weapon_pumpshotgun_mk2'] 		= 0.0,
	['weapon_combatshotgun'] 		= 0.0,

	-- Assault Rifles
	['weapon_assaultrifle'] 		= 0.0,
	['weapon_assaultrifle_mk2'] 	= 0.0,
	['weapon_carbinerifle'] 		= 0.0,
	['weapon_carbinerifle_mk2'] 	= 0.0,
	['weapon_advancedrifle'] 		= 0.0,
	['weapon_specialcarbine'] 		= 0.0,
	['weapon_bullpuprifle'] 		= 0.0,
	['weapon_compactrifle'] 		= 0.0,
	['weapon_specialcarbine_mk2'] 	= 0.0,
	['weapon_bullpuprifle_mk2'] 	= 0.0,
	['weapon_militaryrifle'] 		= 0.0,
    ['weapon_heavyrifle']           = 0.0,

	-- Light Machine Guns
	['weapon_mg'] 				    = 0.0,
	['weapon_combatmg'] 			= 0.0,
	['weapon_gusenberg'] 			= 0.0,
	['weapon_combatmg_mk2'] 		= 0.0,

	-- Sniper Rifles
	['weapon_sniperrifle'] 			= 0.0,
	['weapon_heavysniper'] 			= 0.0,
	['weapon_marksmanrifle'] 		= 0.0,
	['weapon_remotesniper'] 		= 0.0,
	['weapon_heavysniper_mk2'] 		= 0.0,
	['weapon_marksmanrifle_mk2'] 	= 0.0,
    ...
    ['weapon_mp9'] 	                = 0.0,
    ['weapon_mossberg'] 		    = 0.0,
    ['weapon_remington'] 		    = 0.0,
    ['weapon_scarh'] 		    	= 0.0,
    ['weapon_shiv'] 	            = 0.0,
    ['weapon_katana'] 	            = 0.0,
    ['weapon_sledgehammer'] 	    = 0.0,

    -- Attachments
    ['pistol_defaultclip']          = 0.0,
    ['pistol_extendedclip']         = 0.0,
    ['pistol_flashlight']           = 0.0,
    ['pistol_suppressor']           = 0.0,
    ['pistol_luxuryfinish']         = 0.0,
    ['combatpistol_defaultclip']    = 0.0,
    ['combatpistol_extendedclip']   = 0.0,
    ['combatpistol_luxuryfinish']   = 0.0,
    ['appistol_defaultclip']        = 0.0,
    ['appistol_extendedclip']       = 0.0,
    ['appistol_luxuryfinish']       = 0.0,
    ['pistol50_defaultclip']        = 0.0,
    ['pistol50_extendedclip']       = 0.0,
    ['pistol50_luxuryfinish']       = 0.0,
    ['revolver_defaultclip']        = 0.0,
    ['revolver_vipvariant']         = 0.0,
    ['revolver_bodyguardvariant']   = 0.0,
    ['snspistol_defaultclip']       = 0.0,
    ['snspistol_extendedclip']      = 0.0,
    ['snspistol_grip']              = 0.0,
    ['heavypistol_defaultclip']     = 0.0,
    ['heavypistol_extendedclip']    = 0.0,
    ['heavypistol_grip']            = 0.0,
    ['vintagepistol_defaultclip']   = 0.0,
    ['vintagepistol_extendedclip']  = 0.0,

    ['microsmg_defaultclip']        = 0.0,
    ['microsmg_extendedclip']       = 0.0,
    ['microsmg_scope']              = 0.0,
    ['microsmg_luxuryfinish']       = 0.0,
    ['smg_defaultclip']             = 0.0,
    ['smg_extendedclip']            = 0.0,
    ['smg_suppressor']              = 0.0,
    ['smg_drum']                    = 0.0,
    ['smg_scope']                   = 0.0,
    ['smg_luxuryfinish']            = 0.0,
    ['assaultsmg_defaultclip']      = 0.0,
    ['assaultsmg_extendedclip']     = 0.0,
    ['assaultsmg_luxuryfinish']     = 0.0,
    ['minismg_defaultclip']         = 0.0,
    ['minismg_extendedclip']        = 0.0,
    ['machinepistol_defaultclip']   = 0.0,
    ['machinepistol_extendedclip']  = 0.0,
    ['machinepistol_drum']          = 0.0,
    ['combatpdw_defaultclip']       = 0.0,
    ['combatpdw_extendedclip']      = 0.0,
    ['combatpdw_drum']              = 0.0,
    ['combatpdw_grip']              = 0.0,
    ['combatpdw_scope']             = 0.0,

    ['shotgun_suppressor']          = 0.0,
    ['pumpshotgun_luxuryfinish']    = 0.0,
    ['sawnoffshotgun_luxuryfinish'] = 0.0,
    ['assaultshotgun_defaultclip']  = 0.0,
    ['assaultshotgun_extendedclip'] = 0.0,
    ['heavyshotgun_defaultclip']    = 0.0,
    ['heavyshotgun_extendedclip']   = 0.0,
    ['heavyshotgun_drum']           = 0.0,

    ['assaultrifle_defaultclip']    = 0.0,
    ['assaultrifle_extendedclip']   = 0.0,
    ['assaultrifle_drum']           = 0.0,
    ['rifle_flashlight']            = 0.0,
    ['rifle_grip']                  = 0.0,
    ['rifle_suppressor']            = 0.0,
    ['assaultrifle_luxuryfinish']   = 0.0,
    ['carbinerifle_defaultclip']    = 0.0,
    ['carbinerifle_extendedclip']   = 0.0,
    ['carbinerifle_drum']           = 0.0,
    ['carbinerifle_scope']          = 0.0,
    ['carbinerifle_luxuryfinish']   = 0.0,
    ['advancedrifle_defaultclip']   = 0.0,
    ['advancedrifle_extendedclip']  = 0.0,
    ['advancedrifle_luxuryfinish']  = 0.0,
    ['specialcarbine_defaultclip']  = 0.0,
    ['specialcarbine_extendedclip'] = 0.0,
    ['specialcarbine_drum']         = 0.0,
    ['specialcarbine_luxuryfinish'] = 0.0,
    ['bullpuprifle_defaultclip']    = 0.0,
    ['bullpuprifle_extendedclip']   = 0.0,
    ['bullpuprifle_luxuryfinish']   = 0.0,
    ['compactrifle_defaultclip']    = 0.0,
    ['compactrifle_extendedclip']   = 0.0,
    ['compactrifle_drum']           = 0.0,
    ['gusenberg_defaultclip']       = 0.0,
    ['gusenberg_extendedclip']      = 0.0,

    ['sniperrifle_defaultclip']     = 0.0,
    ['sniper_scope']                = 0.0,
    ['snipermax_scope']             = 0.0,
    ['sniper_grip']                 = 0.0,
    ['heavysniper_defaultclip']     = 0.0,
    ['marksmanrifle_defaultclip']   = 0.0,
    ['marksmanrifle_extendedclip']  = 0.0,
    ['marksmanrifle_scope']         = 0.0,
    ['marksmanrifle_luxuryfinish']  = 0.0,
