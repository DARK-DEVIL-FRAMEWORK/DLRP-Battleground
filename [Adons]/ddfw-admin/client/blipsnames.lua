...
CreateThread(function()
    while true do
        ...
        if NetCheck1 or NetCheck2 then
            TriggerServerEvent('ddfw-admin:server:GetPlayersForBlips')
        end
    end
end)

RegisterNetEvent('ddfw-admin:client:toggleBlips', function()
    TriggerServerEvent('ddfw-admin:log:minPage',"other","blips","blue")
...
RegisterNetEvent('ddfw-admin:client:toggleNames', function()
    TriggerServerEvent('ddfw-admin:log:minPage',"other","names","blue")
...
RegisterNetEvent('ddfw-admin:client:Show', function(players)
