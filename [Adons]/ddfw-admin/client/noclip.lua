...
local VehFirstPersonNoClip      = true      -- No Clip in first person when in a vehicle
...
RegisterNetEvent('ddfw-admin:client:ToggleNoClip', function()
    ToggleNoClip(not IsNoClipping)
    TriggerServerEvent('ddfw-admin:log:minPage',"noclip","noclip","black")
end)
