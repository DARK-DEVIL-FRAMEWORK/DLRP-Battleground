...
RegisterNUICallback('showBlur', function()
    Wait(50)
    TriggerEvent("ddfw-inventory:client:showBlur")
end) 
RegisterNetEvent("ddfw-inventory:client:showBlur", function()
    Wait(50)
...
local function CreateItemDrop(index)
	...
	if Config.UseTarget then
		exports['ddfw-target']:AddTargetEntity(dropItem, {
			options = {
				{
...
RegisterNetEvent("ddfw-inventory:client:closeinv", function()
    closeInventory()
end)
...
RegisterNetEvent('ddfw-inventory:client:giveAnim', function()
...
CreateThread(function()
    ...
    -- exports['ddfw-target']:AddTargetModel(toolBoxModels, {
    --         options = {
    --             {
