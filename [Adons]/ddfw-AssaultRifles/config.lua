...
Config = {
    ...
    Translations = {
        ...
        ['leave_paintball'] = '[~g~E~w~] Leave the Assault Rifles gun game queue\n%s',  
        ['left_paintball'] = 'You ~r~left ~w~the Assault Rifles gun game queue since you walked too far away.',
        ['match_in_progress'] = '~r~%s\n~b~%s~w~seconds left.',
        ['gun_removed'] = 'Your Assault Rifles gun game gun got deleted since you are not playing Assault Rifles gun game.',
        ...
        ['no_money'] = 'You do not have enough money to play Assault Rifles gun game!',
