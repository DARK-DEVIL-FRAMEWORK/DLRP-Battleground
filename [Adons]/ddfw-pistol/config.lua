print("^2DDFW^7-^2PistolFight ^4^7^4 ^PistolFight Script by ^1DARK DEVIL^7")
Config = {
    Weapon = 'WEAPON_APPISTOL',
    RemoveWeapon = false, -- if someone has the Weapon but isn't playing paintball, remove it. 
    RequiredPlayers = 1,
    JoinCircle = vector3(202.84, -921.15, 30.69),
    ...
    Translations = {
        ['join_paintball'] = '[~g~E~w~] (costs ~g~$%s~w~) Join the Pistol gun game queue\n%s',
        ['leave_paintball'] = '[~g~E~w~] Leave the Pistol gun game queue\n%s',  
        ['left_paintball'] = 'You ~r~left ~w~the Pistol gun game queue since you walked too far away.',
        ['match_in_progress'] = '~r~%s\n~b~%s~w~seconds left.',
        ['gun_removed'] = 'Your Pistol gun game gun got deleted since you are not playing Pistol gun game.',
        ...
        ['no_money'] = 'You do not have enough money to play Pistol gun game!',
