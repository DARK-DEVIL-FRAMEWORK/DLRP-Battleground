...
RegisterNetEvent('QBCore:Client:UpdateObject', function() QBCore = exports['ddfw-core']:GetCoreObject() end)
...
local function openMenu(data)
	...
	for _, v in pairs(data) do
		if v["icon"] then
			local img = "nui://ddfw-inventory/html/"
...
RegisterNetEvent('ddfw-menu:client:openMenu', function(data) openMenu(data) end)

RegisterNetEvent('ddfw-menu:client:closeMenu', function() closeMenu() end)
