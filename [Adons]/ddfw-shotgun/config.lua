print("^2DDFW^7-^2ShotGunFight ^4^7^4 ^ShotGun Fight Script by ^1DARK DEVIL^7")
Config = {
    ...
    Translations = {
        ...
        ['leave_paintball'] = '[~g~E~w~] Leave the Shotgun gun game queue\n%s',  
        ['left_paintball'] = 'You ~r~left ~w~the Shotgun gun game queue since you walked too far away.',
        ['match_in_progress'] = '~r~%s\n~b~%s~w~seconds left.',
        ['gun_removed'] = 'Your Shotgun gun game gun got deleted since you are not playing Shotgun gun game.',
        ...
        ['no_money'] = 'You do not have enough money to play Shotgun gun game!',
